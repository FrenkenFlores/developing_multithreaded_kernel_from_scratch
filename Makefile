...
# -------------------------------
VPATH=/home/s-evloev/Desktop/developing_multithreaded_kernel_from_scratch/PeachOS/utilities/src/binutils-2.39
...
prefix = /home/s-evloev/Desktop/developing_multithreaded_kernel_from_scratch/PeachOS/utilities/cross
exec_prefix = ${prefix}

srcdir = /home/s-evloev/Desktop/developing_multithreaded_kernel_from_scratch/PeachOS/utilities/src/binutils-2.39
...
TOPLEVEL_CONFIGURE_ARGUMENTS=/home/s-evloev/Desktop/developing_multithreaded_kernel_from_scratch/PeachOS/utilities/src/binutils-2.39/configure --target=i686-elf --prefix=/home/s-evloev/Desktop/developing_multithreaded_kernel_from_scratch/PeachOS/utilities/cross --with-sysroot --disable-nls --disable-werror
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/home/s-evloev/Desktop/developing_multithreaded_kernel_from_scratch/PeachOS/utilities/cross' '--with-sysroot' '--disable-nls' '--disable-werror' --program-transform-name='s&^&i686-elf-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-gnu-as --with-gnu-ld '--prefix=/home/s-evloev/Desktop/developing_multithreaded_kernel_from_scratch/PeachOS/utilities/cross' '--with-sysroot' '--disable-nls' '--disable-werror' --program-transform-name='s&^&i686-elf-&' --disable-option-checking
...
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib --with-cross-host=x86_64-pc-linux-gnu   '--prefix=/home/s-evloev/Desktop/developing_multithreaded_kernel_from_scratch/PeachOS/utilities/cross' '--with-sysroot' '--disable-nls' '--disable-werror' --program-transform-name='s&^&i686-elf-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-elf-gcc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-elf-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-elf-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-elf-c++
